...
import feature3 from "@/app/images/feature3.jpg";
export default function Feature(){
    return(
        <>
        <Header/>
        <div className="max-w-3xl max-md:max-w-xl mx-auto p-4 font-[sans-serif]">
      <h2 className="text-gray-800 text-3xl font-extrabold text-center">Our Features</h2>
      <div className="mt-16 space-y-10">
        <div className="grid md:grid-cols-2 gap-14">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-10 mb-6 bg-gray-100 p-2 rounded-md" viewBox="0 0 32 32">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">Qui elit labore in nisi dolore tempor anim laboris ipsum ad ad consequat id. Dolore et sint mollit in nisi tempor culpa consectetur.</p>
          </div>

          <div className="h-[230px]">
            <Image className="w-full h-full object-cover rounded-xl" src={feature1} alt="feature 1"/>
          </div>
        </div>

        <div className="grid md:grid-cols-2 gap-14">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-10 mb-6 bg-gray-100 p-2 rounded-md" viewBox="0 0 682.667 682.667">
              <defs>
          ...
          <div className="h-[230px]">
            <Image className="w-full h-full object-cover rounded-xl" src={feature2} alt="feature 2"/>
          </div>
        </div>

        <div className="grid md:grid-cols-2 gap-14">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-10 mb-6 bg-gray-100 p-2 rounded-md" viewBox="0 0 24 24">
          ...
          <div className="h-[230px]">
            <Image className="w-full h-full object-cover rounded-xl" src={feature3} alt="feature 3"/>
          </div>
        </div>
      </div>
    </div>
